...
import com.example.handgesterrecognition.ui.compare.image_classification.DistanceCalculation;
...
public class compareFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_compair, container, false);

        btn_gallery1 = root.findViewById(R.id.btn_gallery1);
        btn_gallery2 = root.findViewById(R.id.btn_gallery2);
        btn_histogram_rgb = root.findViewById(R.id.btn_histogram_rgb);
        btn_histogram_gray = root.findViewById(R.id.btn_histogram_gray);
        btn_brisk = root.findViewById(R.id.btn_brisk);
        btn_orb = root.findViewById(R.id.btn_orb);
        tv_title_feature = root.findViewById(R.id.tv_title_feature);
        tv_feature_description = root.findViewById(R.id.tv_feature_description);

        imv_gallery1 = root.findViewById(R.id.imv_gallery1);
        imv_gallery2 = root.findViewById(R.id.imv_gallery2);
        imv_feature_image = root.findViewById(R.id.imv_feature_image);
        imv_feature_image2 = root.findViewById(R.id.imv_feature_image2);

        src1selected = false;
        src2selected = false;

        if(OpenCVLoader.initDebug()){
            Toast.makeText(getActivity(),"OpenCV loaded successfully", Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(getActivity(),"Could not load openCV", Toast.LENGTH_SHORT).show();
        }
        ...
        btn_histogram_rgb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getActivity(),"Extracting histogram feature successfully", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btn_brisk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getActivity(),"Matching BRISK feature successfully", Toast.LENGTH_SHORT).show();
            }
        });
        btn_orb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.append(sum_distance);
                tv_feature_description.setText(builder.toString());
                Toast.makeText(getActivity(),"Matching ORB feature successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == REQUEST_CODE_GALLERRY && resultCode == getActivity().RESULT_OK && data != null) {
