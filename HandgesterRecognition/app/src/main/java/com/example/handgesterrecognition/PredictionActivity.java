...
import com.example.handgesterrecognition.ui.compare.image_classification.*;
...
public class PredictionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.Class_prediction);
        ...
        btn_predict_histogram.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                }else {Toast.makeText(getApplicationContext(),"please select picture", Toast.LENGTH_SHORT).show();}
            }
        });
