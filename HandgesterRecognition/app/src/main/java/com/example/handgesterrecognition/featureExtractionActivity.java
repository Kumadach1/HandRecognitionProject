...
public class featureExtractionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.f_page);

        btn_gallery = findViewById(R.id.btn_gallery);
        btn_gray_histogram = findViewById(R.id.button17);
        btn_histogram = findViewById(R.id.button16);
        btn_orb = findViewById(R.id.button19);
        btn_brisk = findViewById(R.id.button18);
