...
import com.example.handgesterrecognition.ui.compare.image_classification.ImageClassification;
...
public class RockPaperScissorsActivity extends AppCompatActivity {
    ...
    private TextView tv;
    Button btn_gallery, btn_play;
    Uri imageUri;
    ImageView imv_player, imv_computer;
    Mat sampledImgMat;
    Bitmap imageBitmap, grayBitmap;
    String extractedfeatures_hammer, extractedfeatures_scissors, extractedfeatures_paper;
    TextView tv_predicted_class,tv_computer,tv_player_stk,tv_computer_stk,tv_win;
    boolean check = false ;

    //the game variable
    int player_choice = 4 ;
    int Computer_choice = 4 ;
    int player_stk = 0 ; //stack
    int computer_stk = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_gallery = findViewById(R.id.button3);
        btn_play = findViewById(R.id.button);
        imv_computer = findViewById(R.id.imageView12);
        imv_player  = findViewById(R.id.imageView6);
        tv_computer = findViewById(R.id.textView16);
        tv_player_stk = findViewById(R.id.textViewPlayer);
        tv_computer_stk = findViewById(R.id.textViewComputer);
        tv_win = findViewById(R.id.textView30);
                ...
                public void onClick(View v) {
                    if (check) {
                        ...
                        switch (Computer_choice) {
                            case 0:
                                imv_computer.setImageResource(R.drawable.rock);
                                tv_computer.setText("computer : rock"+"("+Computer_choice+")");
                                break;
                            case 1:
                                imv_computer.setImageResource(R.drawable.paper);
                                tv_computer.setText("computer : paper"+"("+Computer_choice+")");
                                break;
                            case 2:
                                imv_computer.setImageResource(R.drawable.scissors);
                                tv_computer.setText("computer : scissors"+"("+Computer_choice+")");
                                break;
                        }
                        ...
                        if (player_choice == 0) {
                            if (Computer_choice == 0) {
                                ...
                                player_stk = 0;
                                computer_stk = 0;
                                tv_player_stk.setText("Player's stack : "+player_stk);
                                tv_computer_stk.setText("Computer's stack : "+computer_stk);
                            }
                    ...
                    imv_player.setImageResource(R.drawable.cap);
                    check = false ;

                    if(player_stk == 3) {
                        //player win
                        tv_win.setText("player win");
                    }else if(computer_stk == 3) {
                        //com win
                        tv_win.setText("computer win");
                    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == REQUEST_CODE_GALLERRY && resultCode == RESULT_OK && data != null) {
            ...
            imv_player.setImageBitmap(imageBitmap);
...
private ArrayList<String> getListOfAllImages(String Current_image_path){
    ...
    cursor = RockPaperScissorsActivity.this.getContentResolver().query(uri, projection, null,
            null, null);
    ...
    private Mat loadImage(String path){
        ...
        org.opencv.core.Point size = new Point();
